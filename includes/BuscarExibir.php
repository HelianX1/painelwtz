...
if (isset($_POST['nome'])) {
    ...
    $sql = "SELECT texto_do_produto, palavra_chave , id_produto
            FROM produtos 
    ...
    if (!$dados) {
        ...
        header("Location: /painelwtz/alterarProduto.php?texto_do_produto=$texto_do_produto&palavra_chave=$palavra_chave&id_produto=$id_produto");
        exit;
    }
}
